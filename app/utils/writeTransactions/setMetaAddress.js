...
import { getWalletClient, getPublicClient, waitForTransactionReceipt } from "wagmi/actions";
import { config } from "../../lib/wallet";

export const setMetaAddress = async ({ address }) => {
  ...
  try {
    ...
    if (e.toString().includes("insufficient funds")) {
      toast.error("You dont have enough gas to execute this transaction.", { id: toastId });
      throw e;
    }
