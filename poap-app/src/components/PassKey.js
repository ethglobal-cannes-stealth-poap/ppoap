...
export const PassKey = () => {
    ...
    useEffect(() => {
        if (!window.PublicKeyCredential) {
            setStatus('❌ WebAuthn is not supported in this browser. Please use a modern browser with WebAuthn support.');
            setStatusType('error');
            setIsWebAuthnSupported(false);
        } else {
            setStatus('ℹ️ WebAuthn is supported. Ready to generate EIP-5564 stealth meta-address!');
            setStatusType('info');
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.intro}>
                ...
                <ul>
                    <li>Creates a WebAuthn credential using <strong>ES256 (ECDSA P-256)</strong></li>
                    <li>Signs the static message <code>"cannes-love-poap"</code> for deterministic key derivation</li>
                    <li>Derives spending and viewing keys using <strong>HKDF</strong> with EIP-5564 compliant salts</li>
            ...
            <div style={styles.demoSection}>
                ...
                {status && (
                    <div style={{
                        ...styles.status,
                        ...styles[`status${statusType.charAt(0).toUpperCase() + statusType.slice(1)}`]
                    }}>
                        {status}
                    </div>
                )}
                ...
                {showResults && results && (
                    <div style={styles.results}>
                        ...
                        <div style={styles.resultItem}>
                            ...
                            <div style={styles.resultValue}>0x{results.spendingPrivateKey}</div>
                        </div>
                        <div style={styles.resultItem}>
                            <div style={styles.resultLabel}>Viewing Private Key:</div>
                            <div style={styles.resultValue}>0x{results.viewingPrivateKey}</div>
                        </div>
                        <div style={styles.resultItem}>
            ...
            <div style={styles.demoSection}>
                <h3>📖 How it works</h3>
                <ol>
                    <li><strong>WebAuthn Credential Creation:</strong> Creates a new passkey using ES256 algorithm</li>
                    <li><strong>Deterministic Signing:</strong> Signs the static message "cannes-love-poap" to get a deterministic signature</li>
                    <li><strong>Key Derivation:</strong> Uses HKDF with EIP-5564 compliant salts to derive spending and viewing keys</li>
                    <li><strong>Public Key Generation:</strong> Generates compressed public keys (33 bytes) from the derived private keys</li>
                    <li><strong>View Tag Generation:</strong> Creates a 1-byte view tag for efficient stealth address parsing</li>
            ...
            <div style={styles.demoSection}>
                ...
                <ul>
                    <li>✅ <strong>Meta-address format:</strong> <code>st:eth:0x&lt;spending&gt;&lt;viewing&gt;</code></li>
                    <li>✅ <strong>Compressed public keys:</strong> 33 bytes each with proper compression flags</li>
                    <li>✅ <strong>View tag:</strong> 1 byte for efficient parsing</li>
                    <li>✅ <strong>Deterministic derivation:</strong> Same passkey always generates same address</li>
                    <li>✅ <strong>HKDF key derivation:</strong> Using EIP-5564 compliant salts</li>
            ...
            <div style={styles.footer}>
                ...
                <p>Reference: <a href="https://nerolation.github.io/stealth-utils/" target="_blank" rel="noopener noreferrer">Stealth Address Guide</a> by nerolation</p>
            </div>
        </div>
    );
};
